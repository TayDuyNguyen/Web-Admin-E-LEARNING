  ...
  return (
    <div className="max-w-4xl mx-auto pb-24">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
        <div>
          <h2 className="text-3xl font-black text-slate-100 tracking-tight">Trình tạo khóa học</h2>
        ...
        <div className="flex items-center gap-3">
           ...
           <button className="px-5 py-2.5 bg-rose-500/10 text-rose-500 border border-rose-500/20 rounded-xl text-xs font-bold hover:bg-rose-500 hover:text-white transition-all">Hủy bỏ</button>
        </div>
      </div>
